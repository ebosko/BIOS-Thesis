...
tib$timeIndex <- as.numeric(factor(tib$Attribute, 
...
```{r}
#model 5 - GEE with lobe and rater as fixed effects and an exchangeable correlation structure
ggo$timeIndex <- as.numeric(factor(ggo$Attribute, 
                                   levels = c("RUL", "RML", "RLL", "LUS", "LLS", "LLL")))
...
```{r}
#model 5 - GEE with lobe and rater as fixed effects and an exchangeable correlation structure
cons$timeIndex <- as.numeric(factor(cons$Attribute, 
                                   levels = c("RUL", "RML", "RLL", "LUS", "LLS", "LLL")))
